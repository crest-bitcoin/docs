...
<CardGroup cols={2}>
  <Card title="Self-Custodial" icon="shield-halved">
    Your Bitcoin never leaves your control. No custody, just secure peer-to-peer trading.
  </Card>
  <Card title="RFQ Engine" icon="gear">
    Real-time quote requests to market makers for optimal pricing.
  </Card>
  <Card title="Trust-minimized Bitcoin" icon="bitcoin">
    Trade the most trust-minimized Bitcoin on the market.
  </Card>
...
<Note>
Both trade types support native cBTC as output token but only RFQ-T supports native cBTC as input token.
</Note>
